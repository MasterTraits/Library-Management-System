...
import TheTables from '../components/TableForBooks'
      ...
      <section className="mt-5 flex text-white">
        <aside className="md:w-96 *:mb-5">
          ...
          <Link to="/" className='shadow-sm hover:bg-white hover:text-blue-600 hover:scale-105 hover:shadow-sm'>
            ...
            <Link to="/books" className='bg-blue-200 scale-105 shadow-sm hover:text-blue-600 hover:scale-105 hover:shadow-sm'>
              📓&nbsp;&nbsp;Books
            </Link>
            <Link to="/borrowing" className='shadow-sm hover:text-blue-600 hover:scale-105 hover:shadow-sm'>
              🖐&nbsp;&nbsp;Borrowing
            </Link>
          </div>
          <CardDivider/>           
