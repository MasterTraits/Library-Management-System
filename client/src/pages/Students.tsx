...
import TheTables from '../components/TableForStudents'
      ...
      <section className="mt-5 flex text-white">
        <aside className="md:w-96 *:mb-5">
          <div className="text-black *:w-full *:text-left *:block *:p-3 *:rounded-lg">
            <Link to="/" className='bg-blue-200 shadow-sm hover:bg-white hover:text-blue-600 hover:scale-105 hover:shadow-sm'>
              🎓&nbsp;&nbsp;Students
            </Link>
            <Link to="/books" className='shadow-sm hover:text-blue-600 hover:scale-105 hover:shadow-sm'>
              📓&nbsp;&nbsp;Books
            </Link>
            <Link to="/borrowing" className='scale-105 shadow-sm hover:text-blue-600 hover:scale-105 hover:shadow-sm'>
              🖐&nbsp;&nbsp;Borrowing
            </Link>
          </div>
          <CardDivider/>           
