...
import {columns, students, statusOptions} from "../../../server/controllers/studentdata";
...
const INITIAL_VISIBLE_COLUMNS = ["name", "student_number", "status", "actions"];


export default function TableForIM() {
        ...
        return (
          <div className="relative flex justify-end items-center gap-2 ">
            <Dropdown>
              ...
              <DropdownMenu className="text-neutral-600">
  ...
  const onRowsPerPageChange = React.useCallback((e: React.ChangeEvent<HTMLInputElement>) => {
          ...
          <div className="flex gap-3">
            <Dropdown>
              ...
              <DropdownMenu
                ...
                onSelectionChange={(keys) => setStatusFilter(keys as unknown as string)}
              >
                {statusOptions.map((status) => (
                  <DropdownItem key={status.uid} className="capitalize text-neutral-600">
            ...
            <Dropdown>
              ...
              >
                {columns.map((column) => (
                  <DropdownItem key={column.uid} className="capitalize text-neutral-600">
        ...
        <div className="flex justify-between items-center">
          ...
          <label className="flex items-center text-default-400 text-small">
            ...
            <select
              ...
              onChange={(e) => onRowsPerPageChange(e as React.ChangeEvent<HTMLInputElement>)}
            >
